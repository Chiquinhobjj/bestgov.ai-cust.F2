    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-background p-4">
      ...
      <Card className="w-full max-w-md bg-card border-border">
        {showRegisterSuccess ? (
          <div className="flex flex-col items-center justify-center p-8">
            <CheckCircle2 className="w-12 h-12 text-bestgov-green mb-4" />
          ...
          <TabsContent value="login">
            <form onSubmit={handleLogin}>
                    ...
                    {isEmailNotVerified ? (
                      <div className="flex flex-col space-y-2">
                        ...
                        <Button 
                          ...
                          className="text-bestgov-green border-bestgov-green hover:bg-bestgov-green/10"
                        >
              ...
              <CardFooter>
                <Button
                  type="submit"
                  className="w-full bg-bestgov-green text-black hover:bg-[#00cc7d]"
                  disabled={isLoading}
                >
      ...
      <div className="mt-4 text-center text-sm text-neutral-500">
        <p>
          ...
          <Link href="#" className="text-bestgov-green hover:underline">
            Terms of Service
          </Link>{" "}
          e{" "}
          <Link href="#" className="text-bestgov-green hover:underline">
