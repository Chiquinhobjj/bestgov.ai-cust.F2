...
export function ChatMessage({
  ...
  const getAvatar = () => {
    if (isUser) {
      return (
        <Avatar className="bg-gradient-to-br from-bestgov-green to-bestgov-green/60 shadow-md border-0">
      ...
      return (
        <Avatar className={`shadow-md border-0 ${
          isFunctionMessage 
            ? "bg-gradient-to-br from-bestgov-green/80 to-bestgov-blue" 
        ...
        <div
          className={`rounded-lg p-3 overflow-hidden relative group shadow-md ${
            isFunctionMessage || isTaskExecutor
              ? "bg-gradient-to-br from-neutral-800 to-neutral-900 border border-neutral-700/50 text-bestgov-green/70 font-mono text-sm"
              : isUser
              ? "bg-bestgov-green text-white"
                ...
                {typeof messageContent === "object" &&
                  "title" in messageContent && (
                    <>
                      ...
                      <div className="flex items-center justify-center w-5 h-5 text-bestgov-green">
                        {isExpanded ? (
              ...
              !isTaskExecutor ? (
                <ReactMarkdown
                  ...
                  components={{
                    ...
                    a: ({ ...props }) => (
                      <a
                        className="text-bestgov-green/70 underline hover:opacity-80 transition-opacity"
                        target="_blank"
                    ...
                    code: ({ className, children, ...props }: any) => {
                      ...
                      if (isInline) {
                        return (
                          <code
                            className="bg-[#333] px-1.5 py-0.5 rounded text-bestgov-green/70 text-sm font-mono"
                            {...props}
                          >
                            {children}
                          </code>
                        ...
                        <div className="my-3 relative group/code">
                          <div className="bg-[#1a1a1a] rounded-t-md border-b border-[#333] p-2 text-xs text-neutral-400 flex justify-between items-center">
                            ...
                            <button
                              ...
                              className="text-neutral-400 hover:text-bestgov-green/70 transition-colors"
                              title="Copy code"
                            >
                              {isCopied ? (
