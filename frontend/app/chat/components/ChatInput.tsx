      ...
      >
        {selectedFiles.length < 5 && (
          <button
            ...
            type="button"
            className="flex items-center justify-center w-9 h-9 rounded-full hover:bg-neutral-800/60 text-neutral-400 hover:text-bestgov-green transition-all border border-neutral-700/30"
            title="Attach file"
          >
        ...
        <Textarea
          ...
          className={`flex-1 bg-neutral-800/40 border-neutral-700/50 text-white focus-visible:ring-bestgov-green/50 focus-visible:border-bestgov-green/50 min-h-[40px] max-h-[240px] resize-none rounded-xl ${className}`}
          disabled={isLoading}
          rows={1}
          ref={textareaRef}
        />
        <Button
          ...
          className={`bg-gradient-to-r from-bestgov-green to-bestgov-green/80 text-white hover:from-bestgov-green/80 hover:to-bestgov-green/60 rounded-full shadow-md h-9 w-9 p-0 ${buttonClassName}`}
        >
          {isLoading ? (
