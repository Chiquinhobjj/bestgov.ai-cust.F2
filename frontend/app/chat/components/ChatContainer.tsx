        ...
        >
          {isInitializing ? (
            <div className="flex flex-col items-center justify-center h-full">
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-bestgov-green to-bestgov-green/80 flex items-center justify-center shadow-lg mb-4 animate-pulse">
      ...
      <div className={cn(
        ...
        {isLoading && !isInitializing && (
          <div className="px-4 py-2 mb-3 rounded-lg bg-neutral-800/50 text-sm text-neutral-400 flex items-center">
            <Loader2 className="h-3 w-3 mr-2 animate-spin text-bestgov-green" />
            Agent is thinking...
          </div>
        )}
        <ChatInput 
