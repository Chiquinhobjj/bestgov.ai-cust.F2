...
export default function AgentsPage() {
  ...
  return (
    <div className="container mx-auto p-6 bg-background min-h-screen flex relative">
      <AgentSidebar
        ...
        <div className="mb-6 flex items-center justify-between">
          <div className="flex items-center">
            {!isSidebarVisible && (
              <button
                ...
                className="mr-2 bg-muted p-2 rounded-md text-accent hover:bg-muted/80 hover:text-accent shadow-md transition-all"
                aria-label="Show folders"
              >
                <Folder className="h-5 w-5" />
              </button>
            )}
            <h1 className="text-3xl font-bold text-foreground flex items-center ml-2">
              {selectedFolderId
          ...
          <div className="flex items-center gap-4">
            ...
            <Button
              ...
              variant="outline"
              className="bg-card text-card-foreground hover:bg-muted/80 border border-input"
            >
            ...
            >
                  <Plus className="h-4 w-4 mr-2 text-bestgov-green" />
              New Agent
                </DropdownMenuItem>
                <DropdownMenuItem
