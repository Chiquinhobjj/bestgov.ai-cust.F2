      ...
      <DialogContent className="sm:max-w-[500px] bg-card border-border text-card-foreground">
        ...
        <div className="py-4">
          <div className="space-y-2">
            <button
              className="w-full text-left px-4 py-3 rounded-md flex items-center bg-muted border border-input hover:bg-muted/80 hover:border-accent/50 transition-colors"
        ...
        <DialogFooter>
          <Button
            ...
            className="bg-muted border-input text-muted-foreground hover:bg-muted/80 hover:text-foreground"
          >
            Cancel
          </Button>
          {isLoading && (
