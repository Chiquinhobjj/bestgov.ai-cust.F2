        ...
        <div className="flex flex-col space-y-4 py-4">
          <div
            className={`h-40 border-2 border-dashed rounded-md flex flex-col items-center justify-center p-4 transition-colors cursor-pointer ${
              dragActive 
                ? "border-bestgov-green bg-bestgov-blue/80/20" 
                : file 
                  ? "border-bestgov-green/80 bg-bestgov-blue/80/10" 
                  : "border-[#444] hover:border-bestgov-green/80/50"
            }`}
          ...
          >
            {file ? (
              <div className="flex flex-col items-center space-y-2">
                <FileJson className="h-10 w-10 text-bestgov-green" />
                <span className="text-bestgov-green font-medium">{file.name}</span>
