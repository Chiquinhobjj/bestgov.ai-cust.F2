  ...
  const FieldList = <T extends Record<string, any>>({ 
    ...
    <div className="border border-neutral-700 rounded-md p-3 bg-neutral-800/50">
                        ...
                        <div className="flex items-center h-9 w-full justify-center">
                          <label className="flex items-center gap-1.5">
                            <input
                              ...
                              className="accent-bestgov-green rounded"
                            />
      ...
      <Button
        ...
        size="sm"
        onClick={onAdd}
        className="w-full border-bestgov-green/30 text-bestgov-green hover:bg-bestgov-green/10 bg-neutral-800/30"
      >
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[850px] max-h-[90vh] overflow-hidden flex flex-col bg-neutral-900 border-neutral-700 p-0">
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="flex items-start justify-between p-6 border-b border-neutral-800">
            <div>
              <h2 className="text-xl font-semibold text-white flex items-center gap-2">
                <Wand className="h-5 w-5 text-bestgov-green" />
            ...
            <div className="flex items-center gap-3">
              <Badge variant="outline" className="bg-neutral-800 text-bestgov-green border-bestgov-green/30 uppercase text-xs font-semibold px-2 py-0.5">
                {tool.method || "GET"}
              </Badge>
            </div>
          </div>
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        activeTab === item.id 
                          ? "bg-bestgov-green/10 text-bestgov-green" 
                    ...
                    >
                      ...
                      {(
                        ...
                        <span className="ml-auto bg-bestgov-green/20 text-bestgov-green text-xs rounded-full px-1.5 py-0.5 min-w-[18px]">
            ...
            />
              ...
              <Button
                            ...
                            className={cn(
                              ...
                              tool.method === method
                                ? "bg-bestgov-green/20 text-bestgov-green border border-bestgov-green/30"
                    ...
                    <div className="p-4 bg-neutral-800/80 border border-bestgov-green/80/20 rounded-md mt-6">
                      <h3 className="text-bestgov-green text-sm font-medium mb-2 flex items-center">
                        <Info className="h-4 w-4 mr-2" /> How to use variables in your endpoint
                      </h3>
                      <p className="text-neutral-300 text-sm mb-3">
                        You can use dynamic variables in your endpoint using the <code className="bg-neutral-700 px-1.5 py-0.5 rounded text-bestgov-green/70">{"{VARIABLE_NAME}"}</code> syntax.
                      </p>
                      <div className="grid grid-cols-1 gap-4 text-xs">
                        <div>
                          ...
                          <code className="block bg-neutral-900 text-neutral-200 p-2 rounded">
                            https://api.example.com/users/<span className="text-bestgov-green">{"{userId}"}</span>/profile
                          </code>
                          <p className="mt-1 text-neutral-400">Define <code className="bg-neutral-700 px-1 py-0.5 rounded text-bestgov-green/70">userId</code> as a Path Parameter</p>
                        </div>
                      </div>
                    </div>
            </div>
              ...
              {activeTab === 'body' && (
                <div className="p-6">
                  <div className="mb-6 p-4 bg-neutral-800/80 border border-bestgov-green/80/20 rounded-md">
                    <h3 className="text-bestgov-green text-sm font-medium mb-2 flex items-center">
                    ...
                    <p className="text-neutral-300 text-sm">
                      ...
                      You can use variables like <code className="bg-neutral-700 px-1.5 py-0.5 rounded text-bestgov-green/70">{"{variableName}"}</code> that will be replaced at runtime.
                    </p>
            </div>
                ...
                <div className="p-6">
                  <div className="mb-6 p-4 bg-neutral-800/80 border border-bestgov-green/80/20 rounded-md">
                    ...
                    <p className="text-neutral-300 text-sm">
                      ...
                      For example, in <code className="bg-neutral-700 px-1.5 py-0.5 rounded text-bestgov-green/70">https://api.example.com/users/{"{userId}"}</code>,
                      <code className="bg-neutral-700 px-1 py-0.5 rounded text-bestgov-green/70">userId</code> is a path parameter.
                    </p>
                  </div>
                ...
                <div className="p-6">
                  <div className="mb-6 p-4 bg-neutral-800/80 border border-bestgov-green/80/20 rounded-md">
                    ...
                    <p className="text-neutral-300 text-sm">
                      ...
                      For example: <code className="bg-neutral-700 px-1.5 py-0.5 rounded text-bestgov-green/70">https://api.example.com/search?query=term&limit=10</code>
                    </p>
            </div>
          ...
          <Button
            onClick={handleSave}
              className="bg-bestgov-green text-neutral-950 hover:bg-bestgov-green"
