                    ...
                    <SelectContent className="bg-[#222] border-[#444] text-white">
                      {availableModelProviders.map((provider) => (
                        <SelectItem
                          ...
                          className="data-[selected]:bg-[#333] data-[highlighted]:bg-[#333] !text-white focus:!text-white hover:text-bestgov-green data-[selected]:!text-bestgov-green"
                        >
                          {provider.label}
                        </SelectItem>
                      ))}
                  ...
                  <div className="grid grid-cols-4 items-center gap-4">
                    ...
                    <div className="col-span-3 flex items-center">
                      <Checkbox
                        ...
                        className="mr-2 data-[state=checked]:bg-bestgov-green data-[state=checked]:border-bestgov-green"
                      />
            ...
            <>
              ...
              {isLoading ? (
                <div className="flex items-center justify-center h-40">
                  <div className="animate-spin rounded-full h-8 w-8 border-t-2 border-b-2 border-bestgov-green"></div>
                </div>
              ) : apiKeys.length > 0 ? (
                <div className="space-y-2">
                  {apiKeys.map((apiKey) => (
                    <div
                      key={apiKey.id}
                      className="flex items-center justify-between p-3 bg-[#222] rounded-md border border-[#333] hover:border-bestgov-green/30"
                    >
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          <Badge
                            variant="outline"
                            className="bg-[#333] text-bestgov-green border-bestgov-green/30"
                          >
                      ...
                      <div className="flex gap-2">
                        <Button
                          ...
                          className="text-neutral-300 hover:text-bestgov-green hover:bg-[#333]"
                        >
                ...
                <div className="text-center py-10 border border-dashed border-[#333] rounded-md bg-[#222] text-neutral-400">
                  ...
                  <Button
                    onClick={handleAddClick}
                    className="mt-4 bg-[#333] text-bestgov-green hover:bg-[#444]"
                  >
                    <Plus className="mr-2 h-4 w-4" />
                    Add Key
                  </Button>
