...
export function ConfigurationTab({
  ...
  const apiKeyField = (
    <div className="space-y-2 mb-4">
      ...
      <div className="border border-border rounded-md p-4 bg-card flex flex-col gap-4">
        <div className="flex flex-col gap-2">
          ...
          <div className="relative flex items-center">
            <input
              id="agent-card-url"
              type="text"
              className="w-full bg-card border-input rounded-md px-3 py-2 text-foreground pr-12 focus:outline-none focus:ring-2 focus:ring-accent/40"
              value={
            ...
            <button
              type="button"
              className="absolute right-2 text-muted-foreground hover:text-accent px-1 py-1"
              onClick={async () => {
        ...
        <div className="flex flex-col gap-2">
          <label className="text-sm text-muted-foreground mb-1" htmlFor="agent-api_key">
          ...
          <div className="relative flex items-center">
            <input
              ...
              className="w-full bg-card border-input rounded-md px-3 py-2 text-foreground pr-24 focus:outline-none focus:ring-2 focus:ring-accent/40"
            ...
            <button
              type="button"
              className="absolute right-9 text-muted-foreground hover:text-accent px-1 py-1"
  ...
  if (values.type === "llm") {
    return (
      <div className="space-y-4">
              ...
              <div className="space-y-2">
                {values.config.mcp_servers.map((mcpConfig) => {
                  ...
                  return (
                    <div
                      key={mcpConfig.id}
                      className="flex items-center justify-between p-2 bg-card/80 rounded-md"
                    >
                      <div>
                      ...
                      <div className="flex gap-2">
                        <Button
                          ...
                          className="flex items-center text-neutral-300 hover:text-bestgov-green hover:bg-[#333]"
                        >
                ...
                <Button
                  ...
                  className="w-full mt-2 border-accent text-accent hover:bg-accent/10 bg-card hover:text-accent"
                >
                  <Plus className="h-4 w-4 mr-1" /> Add MCP Server
                </Button>
              </div>
            ) : (
              <div className="flex items-center justify-between p-2 bg-card/80 rounded-md mb-2">
                <div>
                  <p className="font-medium text-foreground">
                ...
                <Button
                  ...
                  size="sm"
                  onClick={() => onOpenMCPDialog(null)}
                  className="border-accent text-accent hover:bg-accent/10 bg-card hover:text-accent"
                >
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-medium text-foreground">Custom MCPs</h3>
          <div className="border border-border rounded-md p-4 bg-card">
            <p className="text-sm text-muted-foreground mb-4">
            ...
            values.config.custom_mcp_servers.length > 0 ? (
              <div className="space-y-2">
                {values.config.custom_mcp_servers.map((customMCP) => (
                  ...
                  >
                    <div>
                      <p className="font-medium text-foreground">{customMCP.url}</p>
                      <p className="text-sm text-muted-foreground">
                    ...
                    <div className="flex gap-2">
                      <Button
                        ...
                        className="flex items-center text-muted-foreground hover:text-accent hover:bg-muted/50"
                      >
                        <Settings className="h-4 w-4 mr-1" /> Configure
                      </Button>
                      <Button
                        ...
                        className="text-red-500 hover:text-red-400 hover:bg-muted/50"
                      >
                        <X className="h-4 w-4" />
                      </Button>
                    </div>
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-medium text-foreground">Agent Tools</h3>
          <div className="border border-border rounded-md p-4 bg-card">
            <p className="text-sm text-muted-foreground mb-4">
