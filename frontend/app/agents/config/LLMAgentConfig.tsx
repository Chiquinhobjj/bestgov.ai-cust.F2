...
export function LLMAgentConfig({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-4 items-center gap-4">
        <Label htmlFor="goal" className="text-right text-foreground">
          Goal
        </Label>
        <div className="col-span-3">
          <Input
      ...
      <div className="grid grid-cols-4 items-center gap-4">
        <Label htmlFor="api_key" className="text-right text-foreground">
          API Key
        </Label>
        <div className="col-span-3 space-y-4">
          <div className="flex items-center">
            ...
            >
              <SelectTrigger className="flex-1 bg-card border-input text-foreground">
              ...
              <SelectContent className="bg-popover border-border text-popover-foreground">
                {apiKeys.length > 0 ? (
                  apiKeys
                    ...
                    .map((key) => (
                      ...
                      >
                        <div className="flex items-center">
                          <span>{key.name}</span>
                          <Badge className="ml-2 bg-secondary text-accent text-xs">
                            {key.provider}
                          </Badge>
                        </div>
                      </SelectItem>
                  ...
                  <div className="text-muted-foreground px-2 py-1.5 pl-8">
            ...
            <Button
              ...
              className="ml-2 bg-card text-accent hover:bg-muted"
            >
          ...
          {apiKeys.length === 0 && (
            <div className="flex items-center text-xs text-muted-foreground">
              <span className="inline-block h-3 w-3 mr-1 text-muted-foreground">i</span>
              <span>
                You need to{" "}
                <Button
                  variant="link"
      ...
      <div className="grid grid-cols-4 items-center gap-4">
        <Label htmlFor="model" className="text-right text-foreground">
          Model
        </Label>
        <Select
          value={values.model}
        ...
        >
          <SelectTrigger className="col-span-3 bg-card border-input text-foreground">
            <SelectValue placeholder="Select the model" />
          </SelectTrigger>
          <SelectContent className="bg-popover border-border text-popover-foreground p-0">
            <div className="sticky top-0 z-10 p-2 bg-popover border-b border-border">
              <Input
                placeholder="Search models..."
                className="bg-muted border-input text-foreground h-8"
                onChange={(e) => {
      ...
      <div className="grid grid-cols-4 items-center gap-4">
        <Label htmlFor="instruction" className="text-right text-foreground">
          Instructions
        </Label>
        <div className="col-span-3">
          <div className="relative">
            <Textarea
              ...
              className="w-full bg-card border-input text-foreground pr-10"
              rows={4}
              onClick={handleExpandInstruction}
            />
            <button
              type="button"
              className="absolute top-3 right-5 text-muted-foreground hover:text-accent focus:outline-none"
              onClick={handleExpandInstruction}
            >
          ...
          <div className="mt-1 text-xs text-muted-foreground">
            ...
            <span>
              ...
              <span className="ml-2 text-accent">Click to expand editor.</span>
            </span>
          </div>
        </div>
      </div>
      ...
      <Dialog open={isInstructionModalOpen} onOpenChange={setIsInstructionModalOpen}>
        <DialogContent className="sm:max-w-[1200px] max-h-[90vh] bg-card border-border overflow-hidden flex flex-col">
          <DialogHeader>
            <DialogTitle className="text-foreground">Agent Instructions</DialogTitle>
          </DialogHeader>
          ...
          <div className="flex-1 overflow-hidden flex flex-col min-h-[60vh]">
            <Textarea
              ...
              className="flex-1 min-h-full bg-card border-input text-foreground p-4 focus:border-accent focus:ring-accent focus:ring-opacity-50 resize-none"
          ...
          <DialogFooter>
            ...
            <Button 
              ...
              className="bg-bestgov-green text-black hover:bg-[#00cc7d]"
            >
