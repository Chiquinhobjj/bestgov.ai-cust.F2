      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-medium text-white flex items-center">
            <List className="mr-2 h-5 w-5 text-bestgov-green" />
                  ...
                  <div className="flex items-start justify-between mb-2">
                    <div className="flex-1">
                      ...
                      {task.expected_output && (
                        <div className="mt-2">
                          ...
                          <Badge
                            variant="outline"
                            className="ml-2 bg-[#333] text-bestgov-green border-bestgov-green/30"
                          >
                            {task.expected_output}
                          </Badge>
                        </div>
                        ...
                        <div className="mt-2">
                          ...
                          <div className="flex flex-wrap gap-1 mt-1">
                            {task.enabled_tools.map((toolId) => (
                              <Badge
                                key={toolId}
                                className="bg-[#333] text-bestgov-green border border-bestgov-green/30 text-xs"
                              >
                                {toolId}
                              </Badge>
                            ))}
                    ...
                    <div className="flex">
                      <Button
                        ...
                        className="text-neutral-400 hover:text-bestgov-green hover:bg-[#333] mr-1"
                      >
            ...
            <div className="space-y-3 border-t border-[#333] pt-4">
              <h4 className="text-sm font-medium text-white flex items-center justify-between">
                ...
                {isEditing && (
                  <Button
                    ...
                    className="text-neutral-400 hover:text-bestgov-green hover:bg-[#333]"
                  >
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <div className="col-span-2">
                  ...
                  <div className="relative">
                    ...
                    <button
                      type="button"
                      className="absolute top-3 right-5 text-neutral-400 hover:text-bestgov-green focus:outline-none"
                      onClick={handleExpandDescription}
                    >
                  ...
                  <div className="mt-1 text-xs text-neutral-400">
                    ...
                    <span>
                      ...
                      <span className="ml-2 text-bestgov-green">
                ...
                <div className="mt-3">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {newTask.enabled_tools.map((toolId) => (
                      <Badge
                        key={toolId}
                        className="bg-[#333] text-bestgov-green border border-bestgov-green/30"
                      >
                        {toolId}
                      </Badge>
                    ))}
              ...
              <div className="flex items-center justify-between mt-3">
                <Button
                  ...
                  className="border-bestgov-green text-bestgov-green hover:bg-bestgov-green/10 px-3"
                >
                ...
                <Button
                  ...
                  className="bg-[#222] text-bestgov-green border border-bestgov-green hover:bg-bestgov-green/10"
                >
        ...
        <DialogContent className="sm:max-w-[1200px] max-h-[90vh] bg-[#1a1a1a] border-[#333] overflow-hidden flex flex-col">
          ...
          <div className="flex-1 overflow-hidden flex flex-col min-h-[60vh]">
            <Textarea
              ...
              className="flex-1 min-h-full bg-[#222] border-[#444] text-white p-4 focus:border-bestgov-green focus:ring-bestgov-green focus:ring-opacity-50 resize-none"
              ...
              filteredTools.map((tool) => (
                ...
                >
                  <Checkbox
                    ...
                    className="border-[#444] data-[state=checked]:bg-bestgov-green data-[state=checked]:text-black"
                  />
                  <Label
                    htmlFor={tool.id}
                  ...
                  <Badge className="bg-[#333] text-bestgov-green">{tool.id}</Badge>
                </div>
              ))
            ) : (
