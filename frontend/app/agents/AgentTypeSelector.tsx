...
export function AgentTypeSelector({
  ...
  return (
    ...
    >
      <SelectTrigger
        className={`bg-card border-input text-foreground ${className}`}
      >
      ...
      <SelectContent className="bg-card border-border text-foreground">
        {agentTypes.map((type) => (
          <SelectItem
            key={type.value}
            value={type.value}
            className="data-[selected]:bg-accent/20 data-[highlighted]:bg-accent/10 text-foreground focus:!text-foreground hover:text-accent data-[selected]:!text-accent"
          >
