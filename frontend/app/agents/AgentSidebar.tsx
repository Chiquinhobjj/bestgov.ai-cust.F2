  ...
  return (
    <>
      {visible && (
        <button
          onClick={onClose}
          className="absolute right-4 top-4 z-40 bg-card p-2 rounded-md text-accent hover:bg-muted hover:text-accent shadow-md transition-all"
      ...
      <div
        className={`fixed top-0 z-30 h-full w-64 bg-background p-4 shadow-xl transition-all duration-300 ease-in-out ${
      ...
      >
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex space-x-1">
            <Button
              variant="ghost"
              className="h-8 w-8 p-0 text-muted-foreground hover:text-accent hover:bg-muted/50"
              onClick={onAddFolder}
            >
              ...
              <div className="opacity-0 group-hover:opacity-100">
                <DropdownMenu>
                  ...
                  >
                    ...
                    <DropdownMenuItem
                      className="cursor-pointer text-red-500 hover:bg-muted hover:text-red-400 focus:bg-muted"
                      onClick={(e) => {
                        e.stopPropagation();
