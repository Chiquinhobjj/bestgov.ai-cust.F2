    ...
    content: [
      {
        ...
        name: "Agent",
        icon: User,
        color: "text-bestgov-blue",
        bgColor: "bg-bestgov-blue/90/40",
        borderColor: "border-bestgov-blue/30",
        hoverColor: "group-hover:bg-bestgov-blue/80/50",
        glowColor: "group-hover:shadow-bestgov-blue/20",
          ...
          <TabsList className="w-full bg-slate-800/50 grid grid-cols-2 p-1 rounded-lg">
            <TabsTrigger
              ...
              className={cn(
                ...
                "data-[state=active]:bg-gradient-to-br data-[state=active]:from-bestgov-blue/30 data-[state=active]:to-bestgov-blue/40",
                "data-[state=active]:text-bestgov-blue/70 data-[state=active]:shadow-sm",
                  ...
                  >
                    ...
                    <div
                      ...
                      className={cn(
                        ...
                        node.id === "agent-node"
                          ? "hover:from-bestgov-blue hover:to-bestgov-blue/80"
