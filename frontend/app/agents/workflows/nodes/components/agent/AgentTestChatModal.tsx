...
export function AgentTestChatModal({ open, onOpenChange, agent, canvasRef }: AgentTestChatModalProps) {
    ...
    const getAgentTypeIcon = (type: string) => {
        switch (type) {
            ...
            default:
                return <Bot className="h-4 w-4 text-bestgov-green" />;
        }
    };
                    ...
                    <div className="flex items-start justify-between">
                        <div className="flex-1">
                            <div className="flex items-center mb-1">
                                <div className="w-8 h-8 rounded-full bg-gradient-to-br from-bestgov-green/80 to-bestgov-blue/80 flex items-center justify-center shadow-lg mr-3">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-2 mt-1">
                                        <Badge 
                                            className="bg-bestgov-blue/80/40 text-bestgov-green border border-bestgov-green/60/50 px-2"
                                        >
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            >
                                <RefreshCw size={18} className={isInitializing ? "animate-spin text-bestgov-green" : ""} />
                ...
                <div className="flex-1 overflow-y-auto overflow-x-hidden p-3 bg-gradient-to-b from-neutral-900/50 to-neutral-950" ref={messagesContainerRef}>
                    {isInitializing ? (
                        <div className="flex flex-col items-center justify-center h-full">
                            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-bestgov-green to-bestgov-green/60 flex items-center justify-center shadow-lg mb-4 animate-pulse">
                                <Zap className="h-5 w-5 text-white" />
                            </div>
                            <p className="text-neutral-400 mb-2">Initializing connection...</p>
                            <div className="flex items-center space-x-2">
                                <span className="w-2 h-2 rounded-full bg-bestgov-green animate-bounce" 
                        ...
                        <div className="flex flex-col items-center justify-center h-full text-center px-6">
                            <div className="w-14 h-14 rounded-full bg-gradient-to-br from-bestgov-blue/20 to-bestgov-green/20 flex items-center justify-center shadow-lg mb-5 border border-bestgov-green/30">
                        ...
                        <div className="space-y-4 w-full max-w-full">
                            {messages.map((message) => {
                                ...
                                const agentColor = message.author === "user" ? "bg-bestgov-green" : "bg-gradient-to-br from-neutral-800 to-neutral-900";
