    ...
    return (
        <div className="space-y-6">
            {messages.map((message) => {
                ...
                const agentColor = "bg-bestgov-green";
                        ...
                        >
                            ...
                            <div
                                className={`rounded-lg p-3 ${isFunctionMessage || isTaskExecutor
                                    ? "bg-[#333] text-bestgov-green font-mono text-sm"
                                    : isUser
                                        ? "bg-bestgov-green text-black"
                                        : "bg-[#222] text-white"
                            ...
                            >
                                {isWorkflowNode && (
                                    <div className="text-xs text-bestgov-green mb-1 flex items-center space-x-1 bg-bestgov-green/10 p-1 rounded">
                                        ...
                                        {((typeof messageContent === "string" &&
                                            ...
                                            <ReactMarkdown
                                                ...
                                                components={{
                                                    ...
                                                    a: ({ ...props }) => (
                                                        <a
                                                            className="text-bestgov-green underline hover:opacity-80 transition-opacity"
                                                            target="_blank"
                                                    ...
                                                    code: ({ className, children, ...props }: any) => {
                                                        ...
                                                        if (isInline) {
                                                            return (
                                                                <code
                                                                    className="bg-[#333] px-1.5 py-0.5 rounded text-bestgov-green text-sm font-mono"
                                                                    {...props}
                                                                >
                                                                    {children}
                                                                </code>
