      ...
      <div className="mb-3 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <div className="flex h-8 w-8 items-center justify-center rounded-full bg-bestgov-blue/80/40 shadow-sm">
            <Zap className="h-5 w-5 text-bestgov-green" />
          </div>
          <div>
            <p className="text-lg font-medium text-bestgov-green">Start</p>
          </div>
        </div>
      </div>

      <div className="mb-3 rounded-lg border border-bestgov-green/40 bg-bestgov-green/10 p-3 transition-all duration-200 hover:border-bestgov-green/50 hover:bg-bestgov-green/15">
      ...
      <div className="mt-2 flex items-center justify-end text-sm text-neutral-400 transition-colors">
        ...
        <Handle
          className={cn(
            ...
            isSourceHandleConnected ? "!bg-bestgov-green !border-bestgov-green" : "!bg-neutral-400 !border-neutral-500",
            selected && isSourceHandleConnected && "!bg-bestgov-green !border-bestgov-green/70"
          )}
          style={{
            right: "-8px",
            top: "calc(100% - 25px)",
