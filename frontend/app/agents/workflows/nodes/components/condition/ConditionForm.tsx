        ...
        >
          <div className="flex items-start gap-2">
            <div className="bg-bestgov-blue/80/50 rounded-full p-1.5 flex-shrink-0">
              <Filter size={18} className="text-bestgov-blue/70" />
            </div>
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 mt-1">
                <Badge
                  variant="outline"
                  className="text-xs bg-bestgov-blue/80/20 text-bestgov-blue border-bestgov-blue/60/50"
                >
                  Field
                </Badge>
        ...
        <div className="mb-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <Button
              variant="outline"
              size="sm"
              className="h-8 bg-bestgov-blue/20 hover:bg-bestgov-blue/60/30 border-bestgov-blue/60/50 text-bestgov-blue/70"
          ...
          {conditions.length > 0 ? (
            ...
            <div 
              onClick={() => setOpen(true)}
              className="flex flex-col items-center justify-center p-6 rounded-lg border-2 border-dashed border-neutral-700 hover:border-bestgov-blue/80/50 hover:bg-neutral-800/50 transition-colors cursor-pointer text-center"
            >
