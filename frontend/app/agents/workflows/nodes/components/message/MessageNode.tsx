...
export function MessageNode(props: NodeProps) {
  ...
  const getMessageTypeIcon = (type: string) => {
    switch (type) {
      ...
      case "image":
        return <Image className="h-4 w-4 text-bestgov-blue" />;
      case "file":
        return <File className="h-4 w-4 text-bestgov-green" />;
      case "video":
  ...
  const getMessageTypeColor = (type: string) => {
    switch (type) {
      ...
      case "image":
        return 'bg-bestgov-blue/80/30 text-bestgov-blue border-bestgov-blue/60/40';
      case "file":
        return 'bg-bestgov-blue/80/30 text-bestgov-green border-bestgov-green/60/40';
      case "video":
