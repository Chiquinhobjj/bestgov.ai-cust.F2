...
export function BaseNode({
  ...
  const colorStyles = {
    blue: {
      border: "border-bestgov-blue/60/70 hover:border-bestgov-blue",
      gradient: "bg-gradient-to-br from-bestgov-blue/90/40 to-neutral-900/90", 
    ...
    green: {
      border: "border-bestgov-green/60/70 hover:border-bestgov-green",
      gradient: "bg-gradient-to-br from-bestgov-blue/90/40 to-neutral-900/90",
    ...
    emerald: {
      border: "border-bestgov-green/60/70 hover:border-bestgov-green",
      gradient: "bg-gradient-to-br from-bestgov-green/10 to-neutral-900/90",
      glow: "shadow-[0_0_15px_rgba(95,211,174,0.15)]",
      selectedGlow: "shadow-[0_0_25px_rgba(95,211,174,0.3)]"
    },
    slate: {
  ...
  // Selected styles
  const selectedStyle = {
    border: "border-bestgov-green/90",
    glow: colorStyle.selectedGlow
  };
  
  // Executing styles
  const executingStyle = {
    border: "border-bestgov-green",
