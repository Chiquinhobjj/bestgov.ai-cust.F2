  ...
  return (
    <div className={`relative flex items-center gap-2 ${className}`}>
      ...
      <Input
        ...
        autoComplete="off"
        className="pl-10 w-full bg-background border-input text-foreground focus:border-accent focus:ring-accent/10"
      />
      {value && (
        <button
      ...
      {agentTypes.length > 0 && onAgentTypeChange && (
        <Popover open={isFilterOpen} onOpenChange={setIsFilterOpen}>
          <PopoverTrigger asChild>
            <Button
              variant="outline"
              className={`px-3 py-2 bg-background border-input hover:bg-muted ${
                selectedAgentType ? "text-accent" : "text-muted-foreground"
              }`}
            >
