  ...
  const getAgentTypeInfo = (type: AgentType) => {
    ...
    > = {
      llm: {
        ...
        icon: Code,
        color: "#00cc7d",
        bgColor: "bg-bestgov-green/10",
        badgeClass:
          "bg-bestgov-blue/80/30 text-bestgov-green border-bestgov-green/80/30 hover:bg-bestgov-blue/80/40",
      },
      a2a: {
        label: "A2A Agent",
        icon: ExternalLink,
      ...
      workflow: {
        ...
        icon: Workflow,
        color: "#3b82f6",
        bgColor: "bg-bestgov-blue/10",
        badgeClass:
          "bg-bestgov-blue/80/30 text-bestgov-blue border-bestgov-blue/60/40 hover:bg-bestgov-blue/80/40",
      },
      task: {
        label: "Task Agent",
        icon: BookOpenCheck,
        ...
        >
          ...
          <Button
            ...
            className={cn("p-0 h-auto", {
              "text-bestgov-green hover:text-bestgov-green/70": agent.type === "llm",
              ...
              "text-bestgov-blue hover:text-bestgov-blue/70": agent.type === "workflow",
        ...
        <div className="flex border-t border-zinc-800">
          <DropdownMenu>
            ...
            >
              ...
              >
                <FlaskConical className="h-4 w-4 mr-2 text-bestgov-green" />
                Test A2A
              </DropdownMenuItem>
              <DropdownMenuItem
                className="text-white hover:bg-zinc-800 cursor-pointer"
              ...
              >
                <Pencil className="h-4 w-4 mr-2 text-bestgov-green" />
                Edit Agent
              </DropdownMenuItem>
              <DropdownMenuItem
                className="text-white hover:bg-zinc-800 cursor-pointer"
              ...
              {onWorkflow && agent.type === "workflow" && (
                ...
                >
                  <Workflow className="h-4 w-4 mr-2 text-bestgov-blue" />
                  Open Workflow
                </DropdownMenuItem>
              )}
              <DropdownMenuItem
              ...
              {onShare && (
                ...
                >
                  <Share2 className="h-4 w-4 mr-2 text-bestgov-blue" />
                  Share Agent
                </DropdownMenuItem>
              )}
              <DropdownMenuItem
