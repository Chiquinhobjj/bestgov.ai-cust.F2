...
function DocumentationContent() {
  ...
  const renderStatusIndicator = () => {
    switch (streamStatus) {
      case "submitted":
        return (
          <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-bestgov-blue/20 text-bestgov-blue">
            Submitted
          </span>
        );
      case "working":
      ...
      case "completed":
        return (
          <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-bestgov-green/20 text-white">
            Completed
          </span>
        );
      case "failed":
    ...
    if (streamStatus === "working" && !streamComplete) {
      return (
        <div className="flex items-center space-x-1 mt-2 text-neutral-400">
          <div className="w-2 h-2 rounded-full bg-bestgov-green animate-pulse"></div>
          <div
            className="w-2 h-2 rounded-full bg-bestgov-green animate-pulse"
    ...
    <div className="container mx-auto p-6 bg-[#121212] min-h-screen">
      ...
      <div className="text-center mb-8">
        <div className="flex justify-center mb-4">
          <div className="flex items-center space-x-3 bg-gradient-to-r from-bestgov-green/20 to-bestgov-blue/20 px-6 py-3 rounded-full border border-bestgov-green/30">
            <Network className="h-6 w-6 text-bestgov-green" />
            <span className="font-bold text-bestgov-green">A2A Protocol</span>
            <span className="text-xs bg-bestgov-green/20 px-2 py-1 rounded text-bestgov-green/70">v0.2.1</span>
          </div>
        </div>
        <h1 className="text-4xl font-bold bg-gradient-to-r from-bestgov-green via-bestgov-blue to-purple-400 bg-clip-text text-transparent mb-4">
      ...
      >
        <TabsList className="bg-[#121212] w-full mb-6 p-1 rounded-lg grid grid-cols-3">
          <TabsTrigger
            value="docs"
            className="data-[state=active]:bg-bestgov-green/20 data-[state=active]:text-bestgov-green data-[state=active]:border-bestgov-green/50 flex items-center justify-center space-x-2 px-4 py-2 rounded-md transition-all"
          >
        ...
        <TabsContent value="lab">
                ...
                <CardContent className="p-4">
                  <div className="text-sm space-y-2">
                    ...
                    <div className="mt-3 p-2 bg-[#222] rounded text-xs">
                      ...
                      <code className="text-bestgov-green">
          ...
          <div className="mb-6">
            ...
            >
              <h3 className="text-bestgov-green font-semibold flex items-center text-sm">
                🔧 Active A2A Configuration
                <span className="ml-2 text-bestgov-green/70 text-xs">(Real-time feature status)</span>
              </h3>
              <div className="flex items-center space-x-2">
                <span className="text-xs text-neutral-500">
            ...
            {showConfigStatus && (
              <Card className="bg-gradient-to-r from-bestgov-green/5 to-bestgov-blue/5 border-bestgov-green/20 text-white">
                <CardContent className="p-4">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                    <div className="bg-[#222]/50 p-3 rounded-lg">
                      <h4 className="text-bestgov-green font-medium mb-2">Multi-turn Conversations</h4>
                      <div className={`text-xs ${contextId ? 'text-bestgov-green' : 'text-neutral-400'}`}>
                        {contextId ? '✅ Active' : '⏸️ Waiting for contextId'}
                      </div>
                      {contextId && (
                        <div className="text-xs text-bestgov-green/70 mt-1 font-mono">
                    ...
                    <div className="bg-[#222]/50 p-3 rounded-lg">
                      <h4 className="text-bestgov-blue font-medium mb-2">Push Notifications</h4>
                      <div className={`text-xs ${enableWebhooks ? 'text-bestgov-green' : 'text-neutral-400'}`}>
                        {enableWebhooks ? '✅ Enabled' : '❌ Disabled'}
                      </div>
                      {enableWebhooks && webhookUrl && (
                        <div className="text-xs text-bestgov-blue/70 mt-1 truncate">
                          {webhookUrl}
                        </div>
                      )}
                      {enableWebhooks && !webhookUrl && (
                    ...
                    <div className="bg-[#222]/50 p-3 rounded-lg">
                      ...
                      <div className={`text-xs ${showDetailedErrors ? 'text-bestgov-green' : 'text-neutral-400'}`}>
          ...
          <Card className="bg-[#1a1a1a] border-[#333] text-white mb-6">
            <CardHeader>
              <CardTitle className="text-bestgov-green">A2A Testing Lab</CardTitle>
              <CardDescription>
            ...
            <CardContent>
              <Tabs defaultValue="http" onValueChange={setLabMode}>
                <TabsList className="bg-[#222] border-[#333] mb-4">
                  <TabsTrigger
                    value="http"
                    className="data-[state=active]:bg-[#333] data-[state=active]:text-bestgov-green"
                  >
                    HTTP Request
                  </TabsTrigger>
                  <TabsTrigger
          ...
          {response && labMode === "http" && (
            <Card className="bg-[#1a1a1a] border-[#333] text-white">
              <CardHeader>
                <CardTitle className="text-bestgov-green">Response</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-[#1a1a1a] border-[#333] text-white">
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle className="text-bestgov-blue">Debug Logs</CardTitle>
              ...
              {showDebug && (
                <CardContent>
                  <div className="bg-[#0a0a0a] p-4 rounded-md max-h-96 overflow-y-auto">
                    <pre className="text-xs text-bestgov-green whitespace-pre-wrap font-mono">
                      {debugLogs.join('\n')}
                    </pre>
                  </div>
                </CardContent>
      ...
      <Card className="bg-gradient-to-r from-bestgov-green/5 to-bestgov-blue/5 border-bestgov-green/20 text-white mt-12">
        <CardContent className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div>
              <h3 className="font-semibold text-bestgov-green mb-2">Official Resources</h3>
              <div className="space-y-2 text-sm">
                <a 
                  href="https://google.github.io/A2A/specification" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="block text-bestgov-blue hover:text-bestgov-blue/70 transition-colors"
                >
            ...
            <div>
              <h3 className="font-semibold text-bestgov-green mb-2">Implementation Status</h3>
            ...
            <div>
              <h3 className="font-semibold text-bestgov-green mb-2">Need Help?</h3>
              <div className="space-y-1 text-sm text-neutral-300">
          ...
          <div className="border-t border-bestgov-green/20 mt-6 pt-4 text-center text-xs text-neutral-400">
    ...
    <Suspense
      fallback={
        <div className="container mx-auto p-6 bg-[#121212] min-h-screen flex items-center justify-center">
          <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-bestgov-green"></div>
        </div>
      }
    >
