...
export function TechnicalDetailsSection({ copyToClipboard }: TechnicalDetailsSectionProps) {
  return (
    <Card className="bg-[#1a1a1a] border-[#333] text-white">
      <CardHeader>
        <CardTitle className="text-bestgov-green">Technical Details of the Methods</CardTitle>
      </CardHeader>
      <CardContent className="space-y-6">
        <div>
          <h3 className="text-bestgov-green text-lg font-medium mb-2">Method message/send</h3>
...
x-api-key: YOUR_API_KEY`)}
        ...
        <div>
          <h3 className="text-bestgov-green text-lg font-medium mb-2">Method message/stream</h3>
          <p className="text-neutral-300 mb-4">
...
`)}
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-neutral-300 space-y-2 mb-4">
                <li><span className="text-bestgov-green">Status Updates</span>: Contains the <code className="bg-[#333] px-1 rounded">status</code> field with information about the task status.</li>
                <li><span className="text-bestgov-green">Artifact Updates</span>: Contains the <code className="bg-[#333] px-1 rounded">artifact</code> field with the content generated by the agent.</li>
                <li><span className="text-bestgov-green">Ping Events</span>: Simple events with the format <code className="bg-[#333] px-1 rounded">: ping</code> to keep the connection active.</li>
              </ul>
            </div>
  ...
  eventSource.close();
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-neutral-300 space-y-1">
                <li><span className="text-bestgov-green">submitted</span>: Task sent but not yet processed</li>
                <li><span className="text-bestgov-green">working</span>: Task being processed by the agent</li>
                <li><span className="text-bestgov-green">completed</span>: Task completed successfully</li>
                <li><span className="text-bestgov-green">input-required</span>: Agent waiting for additional user input</li>
                <li><span className="text-bestgov-green">failed</span>: Task failed during processing</li>
                <li><span className="text-bestgov-green">canceled</span>: Task was canceled</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#222] p-4 rounded-md border border-[#444]">
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-2">
            <li className="flex items-center">
              <span className="w-3 h-3 bg-bestgov-blue rounded-full mr-2"></span>
            ...
            <li className="flex items-center">
              <span className="w-3 h-3 bg-bestgov-green rounded-full mr-2"></span>
