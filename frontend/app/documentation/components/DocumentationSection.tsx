...
export function DocumentationSection({ copyToClipboard }: DocumentationSectionProps) {
  ...
  return (
    <div className="space-y-8">
      {/* Hero Section */}
      <Card className="bg-gradient-to-br from-bestgov-green/10 to-bestgov-blue/10 border-bestgov-green/20 text-white">
        <CardHeader className="text-center">
          <div className="flex justify-center mb-4">
            <div className="flex items-center space-x-2 bg-bestgov-green/20 px-4 py-2 rounded-full">
              <Network className="h-6 w-6 text-bestgov-green" />
              <span className="font-bold text-bestgov-green">Agent2Agent Protocol</span>
            </div>
          </div>
          <CardTitle className="text-3xl font-bold bg-gradient-to-r from-bestgov-green to-bestgov-blue bg-clip-text text-transparent">
        ...
        <CardContent>
          <div className="flex flex-wrap justify-center gap-4 mt-6">
            <a 
              ...
              className="flex items-center bg-bestgov-green/20 hover:bg-bestgov-green/30 px-4 py-2 rounded-lg transition-colors"
            >
              <FileText className="h-4 w-4 mr-2 text-bestgov-green" />
              <span className="text-bestgov-green">Official Specification</span>
              <ExternalLink className="h-3 w-3 ml-2 text-bestgov-green" />
            </a>
            <a 
              href="https://github.com/google/A2A" 
              target="_blank" 
              rel="noopener noreferrer"
              className="flex items-center bg-bestgov-blue/20 hover:bg-bestgov-blue/30 px-4 py-2 rounded-lg transition-colors"
            >
              <Globe className="h-4 w-4 mr-2 text-bestgov-blue" />
              <span className="text-bestgov-blue">GitHub Repository</span>
              <ExternalLink className="h-3 w-3 ml-2 text-bestgov-blue" />
            </a>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="bg-[#1a1a1a] border-[#333] text-white">
        <CardHeader>
          <CardTitle className="text-bestgov-green flex items-center">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="flex items-start space-x-3">
              <div className="bg-bestgov-green/20 p-2 rounded-lg">
                <MessageSquare className="h-5 w-5 text-bestgov-green" />
              </div>
              <div>
            ...
            <div className="flex items-start space-x-3">
              <div className="bg-bestgov-blue/20 p-2 rounded-lg">
                <FileText className="h-5 w-5 text-bestgov-blue" />
              </div>
              <div>
            ...
            <div className="flex items-start space-x-3">
              <div className="bg-bestgov-green/20 p-2 rounded-lg">
                <Users className="h-5 w-5 text-bestgov-green" />
              </div>
              <div>
      ...
      <Card className="bg-[#1a1a1a] border-[#333] text-white">
        <CardHeader>
          <CardTitle className="text-bestgov-green">Protocol Methods</CardTitle>
        ...
        <CardContent>
          <Tabs defaultValue="messaging" className="w-full">
            <TabsList className="grid w-full grid-cols-3 bg-[#222] border-[#444]">
              <TabsTrigger value="messaging" className="data-[state=active]:bg-bestgov-green/20 data-[state=active]:text-bestgov-green">
                Messaging
              </TabsTrigger>
              <TabsTrigger value="tasks" className="data-[state=active]:bg-bestgov-green/20 data-[state=active]:text-bestgov-green">
                Task Management
              </TabsTrigger>
              <TabsTrigger value="discovery" className="data-[state=active]:bg-bestgov-green/20 data-[state=active]:text-bestgov-green">
                Discovery
              </TabsTrigger>
            </TabsList>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-[#222] p-4 rounded-lg border border-[#444]">
                  <div className="flex items-center space-x-2 mb-3">
                    <Badge variant="outline" className="border-bestgov-green text-bestgov-green">message/send</Badge>
                    <CheckCircle2 className="h-4 w-4 text-bestgov-green" />
                  </div>
                ...
                <div className="bg-[#222] p-4 rounded-lg border border-[#444]">
                  <div className="flex items-center space-x-2 mb-3">
                    <Badge variant="outline" className="border-bestgov-blue text-bestgov-blue">message/stream</Badge>
                    <Zap className="h-4 w-4 text-bestgov-blue" />
                  </div>
            ...
            <TabsContent value="discovery" className="space-y-4">
              <div className="bg-[#222] p-4 rounded-lg border border-[#444]">
                <div className="flex items-center space-x-2 mb-3">
                  <Badge variant="outline" className="border-bestgov-green text-bestgov-green">agent/authenticatedExtendedCard</Badge>
                  <Users className="h-4 w-4 text-bestgov-green" />
                </div>
      ...
      <Card className="bg-[#1a1a1a] border-[#333] text-white">
        <CardHeader>
          <CardTitle className="text-bestgov-green">Quick Start Examples</CardTitle>
          <p className="text-neutral-400">Ready-to-use JSON-RPC examples based on the official A2A specification</p>
        </CardHeader>
        <CardContent>
          <Tabs defaultValue="basic" className="w-full">
            <TabsList className="grid w-full grid-cols-3 bg-[#222] border-[#444]">
              <TabsTrigger value="basic" className="data-[state=active]:bg-bestgov-green/20 data-[state=active]:text-bestgov-green">
                Basic Message
              </TabsTrigger>
              <TabsTrigger value="streaming" className="data-[state=active]:bg-bestgov-green/20 data-[state=active]:text-bestgov-green">
                Streaming
              </TabsTrigger>
              <TabsTrigger value="files" className="data-[state=active]:bg-bestgov-green/20 data-[state=active]:text-bestgov-green">
                File Upload
              </TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="basic" className="space-y-4">
              ...
              <div className="bg-bestgov-blue/10 border border-bestgov-blue/20 rounded-lg p-4">
                <div className="flex items-start space-x-2">
                  <Info className="h-4 w-4 text-bestgov-blue mt-0.5" />
                  <div className="text-sm">
                    <p className="text-bestgov-blue font-medium">Key Points:</p>
                    <ul className="text-bestgov-blue/70 mt-1 space-y-1">
                      <li>• Uses <code className="bg-bestgov-blue/20 px-1 rounded">message/send</code> for standard HTTP requests</li>
                      <li>• <code className="bg-bestgov-blue/20 px-1 rounded">messageId</code> must be a valid UUID v4</li>
            ...
            <TabsContent value="files" className="space-y-4">
              ...
              <div className="bg-bestgov-green/10 border border-bestgov-green/20 rounded-lg p-4">
                <div className="flex items-start space-x-2">
                  <FileText className="h-4 w-4 text-bestgov-green mt-0.5" />
                  <div className="text-sm">
                    <p className="text-bestgov-green font-medium">File Handling:</p>
                    <ul className="text-bestgov-green/70 mt-1 space-y-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-white font-semibold mb-3 flex items-center">
                <Shield className="h-4 w-4 mr-2 text-bestgov-green" />
                Authentication Methods
              </h3>
              <div className="space-y-3">
                <div className="bg-[#222] p-3 rounded-lg border border-[#444]">
                  <div className="flex items-center space-x-2 mb-2">
                    <code className="text-bestgov-green text-sm">x-api-key</code>
                ...
                <div className="bg-[#222] p-3 rounded-lg border border-[#444]">
                  <div className="flex items-center space-x-2 mb-2">
                    <code className="text-bestgov-blue text-sm">Authorization: Bearer</code>
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center space-x-2">
                  <CheckCircle2 className="h-3 w-3 text-bestgov-green" />
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-[#222] border-b border-[#444]">
                  ...
                  <th className="p-4 text-left text-bestgov-green">Agent2Agent (A2A)</th>
                  <th className="p-4 text-left text-bestgov-blue">Model Context Protocol (MCP)</th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr className="border-b border-[#333]">
                  ...
                  <td className="p-4 text-neutral-300 text-bestgov-green">✓ Can use MCP internally</td>
                  <td className="p-4 text-neutral-300 text-bestgov-blue">✓ Complements A2A</td>
                </tr>
              </tbody>
            </table>
          </div>
          <div className="mt-4 bg-bestgov-blue/10 border border-bestgov-blue/20 rounded-lg p-4">
            <p className="text-bestgov-blue/70 text-sm">
