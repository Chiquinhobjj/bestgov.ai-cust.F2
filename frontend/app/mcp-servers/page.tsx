      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogTrigger asChild>
            <Button onClick={resetForm} className="bg-bestgov-green text-bestgov-blue hover:bg-bestgov-green/90">
...
@modelcontextprotocol/server-brave-search"
              ...
              <DialogFooter className="mt-4">
                ...
                <Button type="submit" className="bg-bestgov-green text-black hover:bg-[#00cc7d]" disabled={isLoading}>
                  ...
                  <TableRow key={server.id} className="border-[#333] hover:bg-[#222]">
                      ...
                      <Badge
                        ...
                        className={
                          server.type === "official"
                            ? "bg-bestgov-green/10 text-bestgov-green border-bestgov-green/30"
                    ...
                    <TableCell className="text-neutral-300">
                      <div className="flex items-center">
                        <Tool className="h-4 w-4 mr-1 text-bestgov-green" />
                        {server.tools.length}
                      </div>
                    </TableCell>
                    <TableCell className="text-right">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent className="bg-[#222] border-[#444] text-white">
                          ...
                          >
                            <Edit className="mr-2 h-4 w-4 text-bestgov-green" />
                            Edit
                          </DropdownMenuItem>
                          <DropdownMenuItem
