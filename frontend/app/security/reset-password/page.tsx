      ...
      <Card className="w-full max-w-md">
        <form onSubmit={handleSubmit}>
          ...
          <CardContent className="space-y-4">
            {status === "success" ? (
              <Alert className="border-bestgov-green">
                <CheckCircle2 className="mr-2 h-4 w-4 text-bestgov-green inline" />
          ...
          <div className="mt-4 mb-2 text-center">
            <Link href="/login" className="text-bestgov-green hover:underline">Go to Login</Link>
          </div>
        </form>
      </Card>
    </div>
