      ...
      <div className="space-y-4">
        ...
        >
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-bestgov-green">{agentTypeInfo.label}</p>
            </div>
          </div>
          ...
          <div className="p-4 space-y-4 border-t border-[#1e3a36] animate-in fade-in-50 duration-200">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-[#141414] rounded p-3 flex flex-col justify-between">
                ...
                <div className="flex items-center gap-2">
                  <User className="h-3.5 w-3.5 text-bestgov-green" />
              ...
              <div className="bg-[#141414] rounded p-3 flex flex-col justify-between">
                ...
                <div className="flex items-center gap-2">
                  <Calendar className="h-3.5 w-3.5 text-bestgov-green" />
              ...
              {getTotalTools() > 0 && (
                <div className="bg-[#141414] rounded p-3 flex flex-col justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <Code className="h-3.5 w-3.5 text-bestgov-green" />
              ...
              {getSubAgents() > 0 && (
                <div className="bg-[#141414] rounded p-3 flex flex-col justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <Tag className="h-3.5 w-3.5 text-bestgov-green" />
            ...
            <div className="flex items-center justify-between bg-[#141414] rounded p-3">
              <div className="flex items-center gap-2">
                <Info className="h-3.5 w-3.5 text-bestgov-green" />
                <span className="text-xs text-neutral-400">Agent ID</span>
              </div>
              <span className="text-xs text-bestgov-green font-mono">
                {agent.id}
              </span>
            </div>
            ...
            <Button
              variant="ghost"
              size="sm"
              className="w-full text-bestgov-green hover:text-bestgov-green/80 hover:bg-[#182724] mt-2 border border-[#1e3a36]"
        ...
        <div className="bg-[#182724] rounded-lg overflow-hidden border border-[#1e3a36] p-4">
          <h3 className="text-sm font-medium text-white mb-2 flex items-center gap-2">
            <Key className="h-4 w-4 text-bestgov-green" />
            Access Information
          </h3>
          ...
          <div className="space-y-2">
            <div className="bg-[#141414] rounded p-3">
              <div className="flex justify-between items-center mb-1">
                ...
                <Badge className="bg-bestgov-blue text-white text-xs">
                  {isShared ? "Shared" : "Not Shared"}
                </Badge>
              </div>
              <p className="text-xs font-mono text-bestgov-green">
                {isShared ? "Shared" : "Not Shared"}
              </p>
            </div>
        ...
        <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto bg-neutral-900 border-neutral-800 text-white [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              <ExternalLink className="h-5 w-5 text-bestgov-green" />
              Agent Card
            </DialogTitle>
          </DialogHeader>
