      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {agent && (
          <div className="p-4 border-b border-neutral-700 bg-neutral-900 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              >
                <div className="p-2 rounded-full bg-bestgov-green/20">
                ...
                <div>
                  <h1 className="text-lg font-medium text-white flex items-center gap-2">
                    ...
                    <Button
                      variant="ghost"
                      size="icon"
                      className="h-6 w-6 text-neutral-400 hover:text-bestgov-green p-0.5"
            ...
            <Badge className="bg-bestgov-green text-white px-3 py-1 text-sm border-0">
              Shared Agent
            </Badge>
          </div>
        )}
        ...
        {(selectedSession || agentParams) ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center p-6 bg-neutral-950">
            <div className="w-20 h-20 rounded-full bg-bestgov-green/20 flex items-center justify-center mb-6 border border-bestgov-green/30">
            ...
            <Button
              ...
              className="bg-bestgov-green text-white hover:bg-bestgov-green/80 px-6 py-6 h-auto rounded-xl"
            >
              Connect to Agent
            </Button>
          </div>
        ...
        <DialogContent className="bg-neutral-900 border-neutral-800 text-white max-w-md">
          ...
          <div className="space-y-4 py-2">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-neutral-800 border-neutral-700 text-white focus-visible:ring-bestgov-green"
              />
            </div>
            <div className="space-y-2">
          ...
          <DialogFooter>
            ...
            <Button
              ...
              className="bg-bestgov-green text-white hover:bg-bestgov-green/80"
            >
              Connect
            </Button>
          </DialogFooter>
        ...
        <DialogContent className="bg-neutral-900 border-neutral-800 text-white max-w-3xl h-[80vh]">
          <DialogHeader>
            <div className="flex items-center gap-2">
              <div className="p-1.5 rounded-full bg-bestgov-green/20">
                <Info className="h-5 w-5 text-bestgov-green" />
              </div>
              <DialogTitle className="text-xl font-medium">
