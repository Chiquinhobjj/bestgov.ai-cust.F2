      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogTrigger asChild>
            <Button onClick={resetForm} className="bg-bestgov-green text-black hover:bg-[#00cc7d]">
                  ...
                  <TableRow key={client.id} className="border-[#333] hover:bg-[#222]">
                    ...
                    <TableCell className="text-neutral-300">
                      <div className="flex items-center">
                        <Users className="h-4 w-4 mr-1 text-bestgov-green" />
                    ...
                    <TableCell className="text-right">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent className="bg-[#222] border-[#444] text-white">
                          ...
                          >
                            <UserPlus className="mr-2 h-4 w-4 text-bestgov-green" />
                            Enter as client
                          </DropdownMenuItem>
                          <DropdownMenuItem
